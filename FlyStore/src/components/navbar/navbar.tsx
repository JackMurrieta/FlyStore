    ...
    <>
      ...
      >
        ...
        <div className="nb-section">
          ...
          <button className={`nb-item${active('home')}`} onClick={() => go('home')} type="button">
          ...
          <button className={`nb-item${active('essence')}`} onClick={() => go('essence')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={`nb-item${active('caps')}`} onClick={() => go('caps')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={`nb-item${active('clothes')}`} onClick={() => go('clothes')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={`nb-item${active('shoes')}`} onClick={() => go('shoes')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="nb-section">
          ...
          <button className={`nb-item${active('profile')}`} onClick={() => go('profile')} type="button">
            <span className="nb-ico">
          ...
          <button className={`nb-item${active('favorites')}`} onClick={() => go('favorites')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className={`nb-item${active('orders')}`} onClick={() => go('orders')} type="button">
            <span className="nb-ico">
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="nb-section">
          ...
          <button className="nb-item nb-item--wa" onClick={() => go('whatsapp')} type="button">
            <span className="nb-ico">
      ...
      <nav className="nb-bottom" aria-label="Navegación inferior">
        <div className="nb-bottom-row">
          ...
          >
            {cartCount > 0 && (
              <span className="nb-bn-badge" aria-hidden="true">{cartCount}</span>
            )}
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
